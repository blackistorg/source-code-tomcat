...
public class Request implements org.apache.catalina.servlet4preview.http.HttpServletRequest {
	 ...
	 *
	 * 由HTTP Connector解析header时调用,
	 * 根据web.xml中的SessionCookieName到URL中的Path Parameters获取seesionId,
	 * 并通过setRequestedSessionId方法设置到request中
	 *
	...
	/**
	 * 通过 request. getSession() 方法，如果当前的 Session ID 还没有对应的 HttpSession 对象那么就创建一个新的
	 */
	protected Session doGetSession(boolean create) {
		...
		// 无法给我那句sessionId获取到HttpSession对象则创建
